...
namespace RegisterLogin {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class AdminDataTable : global::System.Data.TypedTableBase<AdminRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AdminRow AddAdminRow(string Name, string Surname, string Phone, string Login, string Password) {
...
namespace RegisterLogin.Database1DataSetTableAdapters {
    ...
    public partial class AdminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Admin] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Surname] = @Original_Surname) AND ([Phone] = @Original_Phone) AND ([Lo" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Admin] ([Name], [Surname], [Phone], [Login], [Password]) VALUE" +
                "S (@Name, @Surname, @Phone, @Login, @Password);\r\nSELECT Id, Name, Surname, Phone" +
                ", Login, Password FROM Admin WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Admin] SET [Name] = @Name, [Surname] = @Surname, [Phone] = @Phone, [Login] = @Login, [Password] = @Password WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Phone] = @Original_Phone) AND ([Login] = @Original_Login) AND ([Password] = @Original_Password));
SELECT Id, Name, Surname, Phone, Login, Password FROM Admin WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RegisterLogin.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Surname, Phone, Login, Password FROM dbo.Admin";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Surname, string Original_Phone, string Original_Login, string Original_Password) {
        ...
        public virtual int Insert(string Name, string Surname, string Phone, string Login, string Password) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, string Phone, string Login, string Password, int Original_Id, string Original_Name, string Original_Surname, string Original_Phone, string Original_Login, string Original_Password, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Phone, string Login, string Password, int Original_Id, string Original_Name, string Original_Surname, string Original_Phone, string Original_Login, string Original_Password) {
            return this.Update(Name, Surname, Phone, Login, Password, Original_Id, Original_Name, Original_Surname, Original_Phone, Original_Login, Original_Password, Original_Id);
        }
    }
